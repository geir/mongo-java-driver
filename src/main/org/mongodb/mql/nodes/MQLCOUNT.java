...
public class MQLCOUNT extends SimpleNode {
    public MQLCOUNT(int id) {
        super(id);
    }

    public MQLCOUNT(MQL p, int id) {
        super(p, id);
    }
...
/* JavaCC - OriginalChecksum=012f66229e2b5373d1c642254871c440 (do not edit this line) */
